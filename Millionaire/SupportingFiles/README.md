...
- [x] **Таймер** с визуальным отображением (30 сек на вопрос)
- [x] **Звуковые эффекты** (фоновая музыка, звуки ответов)
- [x] **Подсказки**: Помощь зала, Звонок другу
- [x] **Экран результатов** с анимацией
- [x] **Сохранение игры** в UserDefaults
